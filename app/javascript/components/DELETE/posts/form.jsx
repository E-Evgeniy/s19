...
export default function Form() {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append(`${ROOT_ADDRESS}[name]`, inputName);
        formData.append(`${ROOT_ADDRESS}[description]`, inputDescribe);
        ...
        try {
            await axios.post(`/api/v1/${ROOT_ADDRESS}s/`, formData, {
                headers: {
                    ...
                    <div className="mx-auto w-full max-w-[550px]">
                        ...
                        <div className="mb-5">
                            <div className="mb-3 block text-base font-medium text-[#07074D]">
                                <label htmlFor={t('description.post_name')} >{t('description.post_name')}</label>
                                <input
