...
export default function MaterialsTable(props) {
    ...
    const classTdLink = `p-2 border-r w-1/4 hover:cursor-pointer hover:bg-gray-300`
                        ...
                        {props.loadedObjects.map((object, index) => {
                            return (
                                <tr key={object.id} className={needHide(object.id)}>
                                    ...
                                    <td className="p-2 border-r w-1/4">{object.average_price}</td>
                                    <td className="p-2 border-r w-1/4">{object.description}</td>
