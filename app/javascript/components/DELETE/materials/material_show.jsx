...
export default function materialShow() {
    ...
    useEffect(() => {
        const apiEndpoint = "/api/v1/materials/" + location

        fetch(apiEndpoint)
            .then(response => response.json())

            .then(data => {
                setLoadedMaterial(data["material"])
                setFiles(data["files"])
                setloading(false)
            }
            );
    ...
    return (
        <div>
                ...
                <div className="w-full h-full flex justify-center items-center">
                    <div
                        ...
                        <div className="mx-4 text-white">
                            <NavLink to="/materials/new">{t('description.material_new')}</NavLink>
                        </div>
                        <div className=" h-8 w-px bg-gray-300"></div>
                    </div>
            ...
            <MaterialTable loadedObject={loadedMaterial} loading={loading} />
