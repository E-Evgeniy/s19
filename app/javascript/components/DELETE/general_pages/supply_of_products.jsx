...
export default function SupplyOfProducts() {
                ...
                <div className="w-full h-full flex justify-center items-center">
                    <div
                        ...
                        <div className="mx-4 text-white">
                            <NavLink to="/manufacturing_plans"> {t('description.manufacturing_plan')} </NavLink>
                        </div>
                        <div className=" h-8 w-px bg-gray-300"></div>
                    </div>
                    ...
                    <div
                        ...
                        <div className=" h-8 w-px bg-gray-300"></div>
                        <div className="mx-4 text-white">
                            <NavLink to="/item_orders"> {t('description.orders')} </NavLink>
                        </div>
                        <div className=" h-8 w-px bg-gray-300"></div>
                    </div>
                    <div className="flex h-full  items-center hover:bg-black hover:bg-opacity-50">
                        <div className="mx-4 text-white">
                            <NavLink to="/clients"> {t('description.clients')} </NavLink>
                        </div>
                        <div className=" h-8 w-px bg-gray-300"></div>
                    </div>
