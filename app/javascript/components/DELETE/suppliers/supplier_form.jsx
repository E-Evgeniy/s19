...
export default function SupplierForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append("supplier[name]", inputName);
        formData.append("supplier[inn]", inputInn);
        formData.append("supplier[address]", inputAddress);
        formData.append("supplier[site]", inputSite);
        formData.append("supplier[email]", inputEmail);
    ...
    useEffect(() => {
        const apiEndpoint = `/api/v1/supplier/find_for_create?input_inn=${inputInn}`
