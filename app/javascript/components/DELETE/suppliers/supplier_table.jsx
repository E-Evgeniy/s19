                ...
                <table className="w-full h-full" style={{ tableLayout: 'fixed' }}>
                    ...
                    <tbody>
                        <tr key={props.loadedObject.id} className={needHide(props.loadedObject.id)}>
                            <td className="p-2 border-r w-1/6">{props.loadedObject.name}</td>
                            <td className="p-2 border-r w-1/6">{props.loadedObject.inn}</td>
                            <td className="p-2 border-r w-1/6">{props.loadedObject.address}</td>
                            <td className="p-2 border-r w-1/6">{props.loadedObject.email}</td>
                            <td className="p-2 border-r w-1/6">{props.loadedObject.site}</td>
