...
export default function Form() {
    ...
    const [inputCoefWeight, setInputCoefWeight] = useState(1.2);  // коэффициент для вычисления веса с поддержками
    const [inputCoefSize, setInputCoefSize] = useState(40);      // коэффициент для вычисления размеров
    const [inputCoefFirstForMatrix, setInputCoefFirstForMatrix] = useState(1.1);      // первый коэффициент для вычисления веса матрицы
    const [inputCoefSecondForMatrix, setInputCoefSecondForMatrix] = useState(1.14);    // второй коэффициент для вычисления веса матрицы
    const [inputDevider, setInputDevider] = useState(1000);        // делитель
    const [inputCoefWorkPrint, setInputCoefWorkPrint] = useState(1);  // коэффициент для вычисления стоимости работы по печати
    const [inputCoefMakeMasterModel, setInputCoefMakeMasterModel] = useState(10);    // коэффициент для вычисления стоимости работы по изготовлению мастер модели
    const [inputCoefMakeMatrix, setInputCoefMakeMatrix] = useState(1);    // коэффициент для вычисления стоимости работы по изготовлению мастер модели
    const [inputCoefPlasticCasting, setInputCoefPlasticCasting] = useState(8);    // коэффициент для вычисления стоимости работы по изготовлению мастер модели
    const [inputCoefClientPrinting, setInputCoefClientPrinting] = useState(50);    // коэффициент для вычисления стоимости работы по клиент печати
    const [inputCoefMakeMatrixUnit, setInputCoefMakeMatrixUnit] = useState(2);    //  коэффициент для вычления стоимости литья за шт
    const [inputTax, setInputTax] = useState(7);    // налог в процентах
    ...
    const [inputCoefCastingUnit, setInputCoefCastingUnit] = useState(30);    // коэффициент для вычис
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append(`item_order[name]`, inputName);
    ...
    useEffect(() => {
        const apiEndpoint = `/api/v1/item_order/find_for_create?input_client_name=${inputClientName}`
    ...
    if (inputName == '' || clientNameFromTable == true) {
        disableButton = true
    }
