...
export default function TechProcessAdd(prop) {
    ...
    const ROOT_ADDRESS = 'item_tech_process'
    const PLURAR = 'es'
    ...
    const { item_id, onTechProcessAdd } = prop;
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append("object[item_id]", item_id);
    ...
    useEffect(() => {
        const apiEndpoint = `/api/v1/${ROOT_ADDRESS}/find_for_add_object?input_name=${inputObjectName}&item_id=${item_id}`
