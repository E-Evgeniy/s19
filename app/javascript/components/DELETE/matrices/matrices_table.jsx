...
export default function MatricesTable(props) {
                        ...
                        {props.loadedObjects.map((object, index) => {
                            return (
                                <tr key={object.id} className={needHide(object.id)}>
                                    ...
                                    <td className="p-2 border-r w-1/5">{object.description}</td>
                                    <td className="p-2 border-r w-1/5">{object.average_price}</td>
