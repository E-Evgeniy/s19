...
export default function FormEdit() {
  ...
  useEffect(() => {
    ...
    const handleSubmit = async (event) => {
        ...
        formData.append("matrix[name]", finalValue(inputName, countEditName, editName));
        formData.append("matrix[average_price]", finalValue(inputAveragePrice, countEditAveragePrice, editAveragePrice));
        formData.append("matrix[description]", finalValue(inputDescription, countEditDescription, editDescription));
        formData.append("matrix[weight]", finalValue(inputWeight, countEditWeight, editWeight));
        formData.append("matrix[length]", finalValue(inputLength, countEditLength, editLength));
        formData.append("matrix[width]", finalValue(inputWidth, countEditWidth, editWidth));
        formData.append("matrix[height]", finalValue(inputHeight, countEditHeight, editHeight));
    ...
    useEffect(() => {
        ...
        const apiEndpoint = `/api/v1/${ROOT_ADDRESS.slice(0, -3)}x/find_for_edit?id=${location}&input_name=${inputName}&count_edit_name=${countEditName}`
                    ...
                    <div className="mx-auto w-full max-w-[550px]">
                        ...
                        <div className="mb-5">
                            <div className="mb-3 block text-base font-medium text-[#07074D]">
                                <label htmlFor="name" style={{ paddingBottom: '100px' }}>{t('description.matrix_name')} </label>
                                <input
