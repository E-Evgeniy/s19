    ...
    return (
        <div>
            ...
            <div className={class_head_text}>
                {t('description.matrix')} {loadedObject.name}</div>

            <MatrixTable loadedObject={loadedObject} loading={loading} />
            <Files files={files} loading={loading} />
            <TechProcessIn loadedObjects={loadedObject0} loading={loading} />
            <TechProcessAdd matrix_id={location} onTechProcessAdd={onTechProcessAdd} />
