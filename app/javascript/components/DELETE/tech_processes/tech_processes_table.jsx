...
export default function TechProcessesTable(props) {
    ...
    const classTdLink = `p-2 border-r w-1/3 hover:cursor-pointer hover:bg-gray-300`
                    ...
                    {props.loadedObjects.map((object, index) => {
                        return (
                                <tr key={object.id} className={needHide(object.id)}>
                                    ...
                                    <NavLink to={String(object.id)}> {outputName(object.name)}
                                    </NavLink></td>
